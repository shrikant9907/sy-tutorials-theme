...
$term = get_term_by('id', $term_id, 'tutorial_tag');
$term_name = $term->name; 
$term_slug = $term->slug; 
...
<h1 class="bg_orange bg_orange_grid m_b_30 p_t_20 p_b_20 text-white f_24_26 text-center">Tag: <?php echo $term_name; ?></h1>
<div class="container">
    <div class="row">
        <div class="col-12 col-sm-3">
            <div class="category_menus r_5 bg-light p_20 m_b_30">
            <p class="m_b_5">Related Tags:</p> 
                <?php   
                // Post Tags
