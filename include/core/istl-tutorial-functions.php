<?php
  ...
  * Tutorial Post Type
  */ 
add_action('init','istl_tutorial_post_type');
function istl_tutorial_post_type() {
 ...
 */
add_action( 'init', 'istl_tutorial_taxonomy', 0 );
function istl_tutorial_taxonomy() {  
 ...
 * Tutorial Meta Box
 */
//add_action( 'add_meta_boxes', 'istl_tutorial_meta_box' );
function istl_tutorial_meta_box(){
    add_meta_box( 'tutorial-details', 'Tutorial Details', 'istl_tutorial_metabox_cb', 'tutorial', 'normal', 'default');
}

function istl_tutorial_metabox_cb($post){
 ...
 */
//add_action( 'save_post', 'istl_tutorial_save_meta_box' );
function istl_tutorial_save_meta_box($post_id){   
